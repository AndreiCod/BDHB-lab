"""
Demo 1 — K-means clustering with PCA (toy dataset: Breast Cancer WDBC)
"""
...
if __name__ == "__main__":
    ...
    plt.title("K-means Clustering (K=2) on PCA data")
    plt.xlabel("PCA 1")
    plt.ylabel("PCA 2")
    plt.colorbar(label="Cluster")
    plt.show()

    # Save results (optional, for consistency with the exercise)
